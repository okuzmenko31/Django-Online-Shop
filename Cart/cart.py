...
class Cart:
    ...
    def save(self):
        """
        When we are calling this method,
        we are saving our cart in the session
        """
    ...
    def __iter__(self):
        """
        Iterating through items in the basket and
    ...
    def get_total_price_for_template(self):
        """
        Getting overall total price of all products
        in the CART, but separated.
        Look at the services.py in the 'Products'
